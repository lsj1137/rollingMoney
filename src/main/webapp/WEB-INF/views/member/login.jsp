...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-lg">
        ...
        <form action="${pageContext.request.contextPath}/member" method="POST" class="space-y-6">
        ...
        <p class="text-center text-sm text-gray-600">
            계정이 없으신가요? 
            <a href="${pageContext.request.contextPath}/member?action=showRegister" class="font-medium text-blue-600 hover:text-blue-500">회원가입</a>
        </p>
    </div>
</div>